...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color fixed-top">
    <a class="navbar-brand" href="#"> <font color="#F0B56F"></font>BUNGOMA COUNTY FILE <font color="#F0B56F"></font>MANAGEMENT <font color="#F0B56F"></font>SYSTEM</a>
...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    ...
    <div class="">
     ...
     <div class=""><p><b style="font-size: 1.1em">Full Name:</b>ICT Revenue Attaches</p></div>
     <div class=""><p><b style="font-size: 1.1em">Position:</b>Software Engineers</p></div>
  ...
  Is a system (based on computer programs in the case of the management of digital documents) used to track, manage and store documents and reduce paper. 
  Most are capable of keeping a record of the various versions created and modified by different users (history tracking).</div>
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><h6 style="font-size: 1.1em">Contact Number</h6><Hr><br><div class=""><p>
    <b style="font-size: 1.1em">Phone:</b> 0745854212</p></div><p><b style="font-size: 1.1em">Address :</b> Bungoma</p>
</div><hr><br>
<!--   <div class="card">
